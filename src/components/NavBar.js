...
const NavBar = ({ routeObject, externalRoutes, compSetter }) => {
  ...
  return (
    <div className="navbar sticky top-0 z-50 flex  md:h-screen flex-row w-full md:flex-col items-center md:px-16 md:max-w-[20%] md:pt-32 bg-background  md:shadow-md">
